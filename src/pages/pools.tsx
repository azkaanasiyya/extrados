    ...
    return (
        <div className="max-w-[1200px] w-full bg-white-neutral-900 border border-white-neutral-800 rounded-[12px] flex flex-col">
            ...
            <div className="px-5 border-b border-white-neutral-800 flex flex-row">
                <div className="py-2.5 px-2 w-full max-w-[424px] text-start text-[12px] leading-[165%] text-white-neutral-400 font-medium">NAME</div>
                <div className="py-2.5 px-2 w-full max-w-[184px] text-end text-[12px] leading-[165%] text-white-neutral-400 font-medium">DETAILS / %CHANGE</div>
                <div className="py-2.5 px-2 w-full max-w-[184px] text-end text-[12px] leading-[165%] text-white-neutral-400 font-medium">TVL</div>
