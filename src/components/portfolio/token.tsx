        ...
        <div className="bg-white-neutral-900 border border-white-neutral-800 rounded-[12px] flex flex-col h-full">
            ...
            <div className="flex flex-col gap-4 px-5 pb-5">
                <div className="flex flex-row py-[17px] gap-[3px]">
                    <div className="w-full max-w-[205px] h-8 rounded-[4px] bg-primary-400"/>
                    <div className="w-full max-w-20 h-8 rounded-[4px] bg-success-400"/>
                    <div className="w-full max-w-14 h-8 rounded-[4px] bg-secondary-400"/>
                </div>
