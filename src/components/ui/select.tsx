  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-5 text-base-white transition-transform duration-200 group-data-[state=open]:rotate-180" />
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-5 text-white-neutral-300" />
        </SelectPrimitive.ItemIndicator>
      </span>
